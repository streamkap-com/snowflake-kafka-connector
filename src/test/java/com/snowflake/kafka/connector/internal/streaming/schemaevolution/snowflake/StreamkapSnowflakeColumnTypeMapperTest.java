...
class StreamkapSnowflakeColumnTypeMapperTest {
  ...
  private static Stream<Arguments> debeziumTypesToMap() {
    return Stream.of(
        Arguments.of(Schema.Type.INT32, "io.debezium.time.Date", "DATE"),
        Arguments.of(Schema.Type.INT32, "io.debezium.time.Time", "TIME(3)"),
        Arguments.of(Schema.Type.INT64, "io.debezium.time.MicroTime", "TIME(6)"),
        Arguments.of(Schema.Type.INT64, "io.debezium.time.Timestamp", "TIMESTAMP"),
